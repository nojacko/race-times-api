...
mkdir -p "$DIR_WEB/src/lib/data/formula-e/2025-26"
...
copy_if_exists "$DIR_API/src/data/formula-e/2025-26/calendar.ts" "$DIR_WEB/src/lib/data/formula-e/2025-26/calendar.ts"
